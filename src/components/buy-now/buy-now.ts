export class Validation {
  ...
  paymentSystem(numCard: string) {
    ...
    if (numCard[0] === '4') {
      imgBank.src = require('Img/visa.png');
    } else if (numCard[0] === '5') {
      imgBank.src = require('Img/mastercard.png');
    } else if (numCard[0] === '6') {
      imgBank.src = require('Img/american.png');
    } else {
      imgBank.src = require('Img/bankpassen-1.png');
    }
  }

  validThru(thruCard: string) {
    const arr = thruCard.split('/');
